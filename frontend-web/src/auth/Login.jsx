      ...
      <div className="relative flex flex-col sm:flex-row items-center justify-center bg-transparent rounded-3xl ">
        ...
        <div className="flex justify-center self-center z-10 p-10 bg-white rounded-3xl w-full sm:w-96">
          <div className="w-full">
            ...
            <div className="mb-6">
              <h3 className="font-semibold text-2xl text-gray-800">Login to your account</h3>
            ...
            <form className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <a href="#" className="text-sm font-medium text-[#F27C1C] hover:underline">Forgot password?</a>
              </div>
              ...
              <p className="text-sm font-light text-gray-500">
                Don’t have an account yet? <a href="#" className="font-medium text-[#F27C1C] hover:underline">Sign up</a>
              </p>
            </form>
          </div>
        </div>
