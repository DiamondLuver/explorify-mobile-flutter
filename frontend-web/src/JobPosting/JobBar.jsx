  ...
  <div className="w-full md:w-1/2">
    <form className="flex items-center">
      ...
      <div className="relative w-full">
        ...
        <input type="text" id="simple-search" className="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-[#f7ac70] focus:border-[#f7ac70]  " placeholder="Search" required />
      </div>
    </form>
  </div>
