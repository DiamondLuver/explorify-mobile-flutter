...
def send_registration_confirmation_email(user_email, user):
    ...
    html_message = render_to_string(
        "email/company/registration_email.html", {"user": user}
    )
...
def send_approval_notification_email(company_name, contact_email):
    ...
    html_message = render_to_string(
        "email/admin/approval_notification.html",
    ...
    bcc = [
        "unsreypich999@gmail.com",
        "heaklinh@gmail.com",
        "chanmaliza.tann@student.cadt.edu.kh",
    ]
