    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('headline', models.CharField(blank=True, max_length=255, null=True, verbose_name='Headline')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('contact_information_id', models.BigAutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('staff_first_name', models.CharField(blank=True, max_length=255, null=True)),
                ('staff_last_name', models.CharField(blank=True, max_length=255, null=True)),
                ('staff_email', models.CharField(blank=True, max_length=255, null=True)),
                ('staff_password', models.CharField(blank=True, max_length=255, null=True)),
                ('staff_telephone', models.CharField(blank=True, max_length=20, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('staff_role', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='account.role')),
            ],
            options={
                'verbose_name': 'Staff',
